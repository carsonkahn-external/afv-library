...
The `description` should explain both what the skill does and when to use it, including keywords that help agents identify relevant tasks. As always, LLMs can help you optimize and test different description formulations, if necessary.
...
2. Install the experiment [AFV library VS Code extension](https://github.com/forcedotcom/afv-library-extension). 
